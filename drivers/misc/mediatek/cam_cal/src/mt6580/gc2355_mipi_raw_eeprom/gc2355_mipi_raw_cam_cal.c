...
#define CAM_CAL_DRVNAME "CAM_CAL_GC2355"
static struct i2c_board_info __initdata kd_cam_cal_dev={ I2C_BOARD_INFO(CAM_CAL_DRVNAME, 0xA4>>1)}; //make dummy_eeprom co-exist
