...
#define MAX_CHARGE_TEMPERATURE  55 //50 modify by xiaopu.zhu for jrd policy
#define MAX_CHARGE_TEMPERATURE_MINUS_X_DEGREE	50 //47 modify by xiaopu.zhu for jrd policy
#define MIN_CHARGE_TEMPERATURE  0
#define MIN_CHARGE_TEMPERATURE_PLUS_X_DEGREE	2 //6 modify by xiaopu.zhu for jrd policy
#define ERR_CHARGE_TEMPERATURE  0xFF

#define MAX_WARNING_TEMPERATURE  58 //ADD by xiaopu.zhu for jrd policy
#define MIN_WARNING_TEMPERATURE  -18 //ADD by xiaopu.zhu for jrd policy

/* Linear Charging Threshold */
#define V_PRE2CC_THRES	 		3400	//mV
#define V_CC2TOPOFF_THRES		4050
#define RECHARGING_VOLTAGE      4275
/*modify by xiaopu.shu for cv current from 100 to 150mA*/
...
/* charger error check */
#define BAT_LOW_TEMP_PROTECT_ENABLE         // stop charging if temp < MIN_CHARGE_TEMPERATURE //enable by xiaopu.zhu for jrd policy
...
#define SYNC_TO_REAL_TRACKING_TIME  		30	// modify by xiaopu.zhu to 30 earily 60 second
